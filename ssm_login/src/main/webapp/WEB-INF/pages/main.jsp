...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/time.js"></script>
 <script>
	window.onload=function(){
		...
		var flag=false;
		var cccc  = function changeImage(){
			if(flag == false){
		    var s = document.getElementById('state1');
		    	s.src ="${pageContext.request.contextPath}/images/new.jpg";   
		    }else{
		   		s.src ="${pageContext.request.contextPath}/images/old.jpg";
		    }
				flag = true;
		};
	...
	<%-- <%					 
	// String iboy = "${pageContext.request.contextPath}/images/new.jpg";
	// String igirl = "${pageContext.request.contextPath}/images/old.jpg";
	// String images=mess.readFlag==0?iboy:igirl;
	//>%
	<%--  <%=images %>  --%> 
 ...
 <body>
	...
	<div id="header_menu">
			...
			<ul>
				...
				<li><a href="${pageContext.request.contextPath}/user/help"><font color="#ffe4c4" size="3px">帮助</font></a></li>
			...
			<table cellpadding="0" cellspacing="0">
				<tr class="first_row">
					...
					<c:forEach var="mess" items="${mess}">
						...
						<img id="state1" src=${mess.readFlag == 0?"../images/new.jpg":"../images/old.jpg"}>
						</td>
					<td>
							${mess.sendUser} ${mess.readFlag} 
					</td>
